                ...
                <div ref={receiptRef} style={styles.receiptCard}>
                  ...
                  <div style={styles.receiptBody}>
                    ...
                    <div style={styles.receiptRowItem}>
                      ...
                      <span style={styles.receiptValueText}>{senderName}</span>
                    </div>
                    <div style={styles.receiptRowItem}>
                      <span style={styles.receiptLabelText}>Sender Wallet ID</span>
                      <span style={styles.receiptValueText}>{senderWalletId}</span>
                    </div>
